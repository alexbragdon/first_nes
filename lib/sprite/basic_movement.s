...
; =========================================
; Subroutine to move the Luigi sprites down
; =========================================
...
.PROC     MoveLuigiDown
    ...
    sec                             ; 
    adc     #$01                    ; 
    sta     $0200                   ; Decrement Sprite0 X position

    lda     $0204                   ; 
    sec                             ; 
    adc     #$01                    ; 
    sta     $0204                   ; Decrement Sprite1 X position

    lda     $0208                   ; 
    sec                             ; 
    adc     #$01                    ; 
    sta     $0208                   ; Decrement Sprite2 X position

    lda     $020c                   ; 
    sec                             ; 
    adc     #$01                    ; 
    sta     $020c                   ; Decrement Sprite3 X position
